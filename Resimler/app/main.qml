...
ApplicationWindow {
  ...
  //  visibility: Window.FullScreen
    ...
    property string currentTimeText: "00:00:00" // Current time display
    
    // Material Manager (dummy for demo)
    QtObject {
        id: materialManager
    ...
    // Helper function for status LED color
    ...
    Timer {
        ...
        onTriggered: {
            var now = new Date()
            mainWindow.currentTimeText = Qt.formatTime(now, "HH:mm:ss")
        }
    }
    ...
    Component {
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                height: 36
                radius: 18
                color: mainWindow.getStatusLEDColor(mainWindow.currentLogType)
            ...
            Row {
                ...
                Row {
                    ...
                    Text {
                        id: currentTimeValue
                        text: mainWindow.currentTimeText
                        color: "white"
                        font.pixelSize: 16
                        font.bold: true
                        anchors.verticalCenter: parent.verticalCenter
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                Text {
                    text: "Status LED: " + mainWindow.currentLogType + " | Color: " + mainWindow.getStatusLEDColor(mainWindow.currentLogType)
                    color: "#ffff00"
                    font.pixelSize: 11
                    font.family: "Courier New"
                }
